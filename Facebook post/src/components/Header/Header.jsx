...
export const Header = () => {
    const color = 'rgba(24,119,242,255)';
    return (
        <header>
            <div className="fb-header">
                ...
                <div className="header-icons">
                    <div className='header-icon'>
                        <img src="/images/fbmessenger.png" alt="" srcset="" width='25px' height='25px' />
                    </div>
                    <div className='header-icon'>
                        <FontAwesomeIcon icon={faBell} style={{ color: "#00040a", fontSize: '18px' }} />
                    </div>
                    <div className='header-icon'>
                        <img src="https://images.squarespace-cdn.com/content/v1/5bfc8dbab40b9d7dd9054f41/1543424201416-S6Q5OPV25MXETU154ZLQ/Randy+Krum+Profile+Photo+square.jpg?format=1000w" alt="" srcset="" className='header-profile-img' />
                    </div>
                </div>
            </div>
        </header>
